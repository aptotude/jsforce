  ...
  */
  var createRequest = function makeRequest() {
    ...
    if (!req) {
      ...
      // TODO: make env variable to toggle off and on
      ...
      // TODO: MAKE SURE ONLY "GET"'s YO! AND FEATURE TOGGLE IT

      operation.attempt(function() {
        var timedOut = true;

        req = httpRequest(opts, function(err, response) {
          if (response && response.timingPhases && response.timingPhases.total > 300) {
        ...
        // TODO Make the timeout an env variable
      });
    }
    return req;
  };
